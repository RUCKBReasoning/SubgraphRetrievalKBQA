...
def get_model(cfg, num_kb_relation, num_entities, num_vocab):
    word_emb_file = None if cfg['word_emb_file'] is None else os.path.join(cfg['data_folder'], cfg['word_emb_file'])
    entity_emb_file = None if cfg['entity_emb_file'] is None else os.path.join(cfg['data_folder'], cfg['entity_emb_file'])
    entity_kge_file = None if cfg['entity_kge_file'] is None else os.path.join(cfg['data_folder'], cfg['entity_kge_file'])
    relation_emb_file = None if cfg['relation_emb_file'] is None else os.path.join(cfg['data_folder'], cfg['relation_emb_file'])
    relation_kge_file = None if cfg['relation_kge_file'] is None else os.path.join(cfg['data_folder'], cfg['relation_kge_file'])
