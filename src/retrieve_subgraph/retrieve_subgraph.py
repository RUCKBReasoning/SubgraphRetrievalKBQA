...
def run():
    ...
    dump_jsonl(train_dataset, os.path.join(
        dump_data_folder, "train_simple_debug.json"))
    dump_jsonl(test_dataset, os.path.join(
        dump_data_folder, "test_simple_debug.json"))
    dump_jsonl(dev_dataset, os.path.join(dump_data_folder, "dev_simple_debug.json"))
