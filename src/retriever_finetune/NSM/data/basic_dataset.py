...
class BasicDataLoader(object):
    ...
    def _load_data(self):
        ...
        self.candidate_entities_name = [['[PAD]' for _ in range(self.max_local_entity)] for __ in range(self.num_data)]
        ...
        for sample in tqdm(self.data):
            ...
            for global_entity, local_entity in g2l.items():
                ...
                if local_entity not in tp_set:  # skip entities in question
                    ...
                    self.candidate_entities_name[next_id][local_entity] = global_entity
